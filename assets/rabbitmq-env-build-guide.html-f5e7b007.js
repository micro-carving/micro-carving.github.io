import{_ as a,W as n,X as s,a1 as e}from"./framework-158a71b3.js";const t={},i=e(`<h2 id="docker-下环境搭建命令总结" tabindex="-1"><a class="header-anchor" href="#docker-下环境搭建命令总结" aria-hidden="true">#</a> docker 下环境搭建命令总结</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 1.查询可用镜像（一般选择官方或者使用最多的镜像）</span>
